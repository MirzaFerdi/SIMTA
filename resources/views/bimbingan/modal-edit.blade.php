            ...
            <div class="modal-content">
                ...
                <form action="{{ route('bimbingan.update', $bim->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <input type="hidden" name="dospem_type" value="{{ $bim->dospem1 ? 'dospem1' : 'dospem2' }}">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="dospem" name="{{ $bim->dospem1 ? 'dospem1' : 'dospem2' }}" required>
                                <option hidden value="">Pilih Dosen Pembimbing</option>
                                @foreach ($dospem as $dos)
                                    <option value="{{ $dos->id }}"
                                        @if (($bim->dospem1 && $bim->dospem1 == $dos->id) || ($bim->dospem2 && $bim->dospem2 == $dos->id)) selected @endif>
                                        {{ $dos->nama }}
                                    </option>
                                @endforeach
                            </select>
    ...
    <div class="modal fade" id="editModal{{ $bim->id }}" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('bimbingan.updateStatus', $bim->id) }}" method="POST"
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="status" name="status" required>
                                <option value="Maju Sempro" {{ $bim->status == 'Maju Sempro' ? 'selected' : '' }}>
                                    Maju Sempro</option>
