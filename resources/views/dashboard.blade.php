    ...
    <div class="row g-4">
        ...
        <div class="col-md-6">
            <div class="card shadow border-0 rounded-4 bg-light bg-gradient hover-shadow transition">
                <div class="card-body p-4 d-flex align-items-center">
                    <div class="me-4">
                        <div class="rounded-circle d-flex justify-content-center align-items-center" style="width: 60px; height: 60px; background: #f8d7da;">
        ...
        <div class="col-md-6">
            <div class="card shadow border-0 rounded-4 bg-light bg-gradient hover-shadow transition">
                <div class="card-body p-4 d-flex align-items-center">
                    <div class="me-4">
                        <div class="rounded-circle d-flex justify-content-center align-items-center" style="width: 60px; height: 60px; background: #cfe2ff;">
        ...
        <div class="col-12">
            <div class="card shadow border-0 rounded-4">
                <div class="card-body p-5">
                    ...
                    <p class="mb-4">Untuk dapat mengikuti dan menyelesaikan Tugas Akhir (TA), mahasiswa wajib memenuhi beberapa ketentuan berikut:</p>
                    <ol class="mb-4 ps-3">
                        <li class="mb-2">Mahasiswa <strong>wajib</strong> mengisi form bimbingan sebagai bagian dari monitoring progres TA.</li>
                        <li class="mb-2">Dosen pembimbing telah ditentukan oleh program studi D-III TI dan JTI (JTI Malang).</li>
                        <li class="mb-2">Mahasiswa <strong>wajib</strong> melakukan bimbingan secara aktif dengan jumlah minimal:
                            <ul class="mt-2">
                                <li>Dosen pembimbing 1: Minimal <strong>8x</strong> bimbingan</li>
                                <li>Dosen pembimbing 2: Minimal <strong>5x</strong> bimbingan</li>
                            </ul>
                        </li>
                        <li class="mb-2">Mahasiswa <strong>wajib</strong> mengunggah file proposal TA (PDF) sesuai format yang telah ditentukan.</li>
                        <li class="mb-2">Mahasiswa menyiapkan dokumen Berita Acara SEMPRO TA secara mandiri dan harus ditandatangani oleh seluruh dosen yang bersangkutan serta diserahkan ke admin program studi.</li>
                        <li class="mb-2">Mahasiswa <strong>wajib</strong> mengikuti SEMPRO sesuai jadwal yang telah ditentukan oleh panitia TA.</li>
                        <li class="mb-2">Mahasiswa <strong>tidak dapat</strong> mendaftar sidang Tugas Akhir jika tidak memenuhi syarat jumlah minimal bimbingan.</li>
                        <li class="mb-3">Untuk menjaga formalitas dan profesionalisme dalam pelaksanaan Seminar/Sidang Tugas Akhir, mahasiswa <strong>wajib</strong> mengenakan pakaian sesuai ketentuan dresscode berikut:</li>
                    </ol>
