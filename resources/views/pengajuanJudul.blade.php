            ...
            <div class="card  shadow border-0 rounded-4">
                <div class="card-body p-4">
                    ...
                    <button class="btn btn-primary mb-3" data-bs-toggle="modal"
                        data-bs-target="#tambahModal">Tambah Pengajuan</button>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        ...
                                        <form action="{{ route('pengajuan.delete', $pJ->id) }}" method="POST"
                                            class="d-inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus Judul ini?')">
                                            @csrf
                                            @method('DELETE')
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="editModalLabel">Edit Pengajuan Judul</h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                    aria-label="Close"></button>
                                            </div>
                                            <form action="{{ route('pengajuan.update', $pJ->id) }}" method="POST"
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select" id="pengusul1" name="pengusul1" disabled>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select" id="pengusul2" name="pengusul2" disabled>
