...
<div class="container mt-3">
    @if (session('success'))
    <div class="alert position-absolute top-0 end-0 z-2 alert-success alert-dismissible fade show" role="alert" id="success-alert">
        <strong>Berhasil!</strong> {{ session('success') }}
        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
    </div>
    @endif
    @if ($errors->any())
    <div class="alert position-absolute top-0 end-0 z-2 alert-danger alert-dismissible fade show" role="alert" id="error-alert">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card position-relative z-1 shadow border-0 rounded-4">
                        ...
                        <form method="POST" action="{{ route('pengajuan.store') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="tahun" name="tahun"
                                    ...
                                    value="{{ $pengajuanUser->first()->tahun ?? '' }}"
                            ...
                            <div class="mb-3">
                                ...
                                @method('PUT')
                                @endif
                                <button type="submit" class="btn btn-success d-none" id="updateBtn" formaction="{{ route('pengajuan.update', $pengajuanUser->first()->id ?? 0) }}">Update</button>
                                <script>
